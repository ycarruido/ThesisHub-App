...
export class InvoicesComponent {
  ...
  constructor(private router: Router, private userService: UserService, private loginService: LoginService, private invoiceService: InvoiceService, private alertService: AlertService) { }
