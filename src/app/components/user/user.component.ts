...
export class UserComponent implements OnInit  {
  ...
  constructor(private router:Router, private roleService: RoleService, private locationService: LocationService, private route: ActivatedRoute, private loginService: LoginService, private userService: UserService, private alertService: AlertService) { }
  ...
  editUser(userUp: UserModel) {
    ...
    if (this.user.country){
      this.locationService.getAllCityName(this.user.country).valueChanges().subscribe((data: CountryModel[]) => {
        this.cityList = data;
      });
    }
  ...
  moForm(){
    ...
    this.rutaTo('register');

   //nteriormente se llamadab al form de de icluir usuarios
